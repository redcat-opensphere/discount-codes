...
Implement the REST API that puts the values in the cache. Implement the REST API that given the type discount code (PERCENT or VALUE) displays the list of discount codes available.
